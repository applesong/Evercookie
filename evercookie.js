...
this.get = function(name, cb, dont_reset)//cb=callback() cb是一个回调函数，也就是一个函数名
{
...
this.evercookie_window = function(name, value)//取得窗口名
{
	try {
		if (typeof(value) != "undefined")
...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		document.cookie = 'evercookie_cache=' + value;//设置cookie
